# script.abemachat
# ABEMATV chat addon for kodi

ABEMAの生放送のチャットを表示するkodiアドオンです。

Keymap Editor アドオン等を使用して、リモコンにアドオンの起動を割り当ててください
...
## 謝辞
このアドオンは [script.ircchat](https://github.com/divingmule/script.ircchat) を参考にして開発しました。ライセンスはGPL V2になります。
